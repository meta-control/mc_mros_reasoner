...
from mros1_reasoner.tomasys import updateQAvalue, resetFDRealisability, resetObjStatus
...
class Reasoner(object):
    ...
    def get_new_tomasys_objective(self, objective_name, iri_seed):
        ...
        """
        objective = self.tomasys.Objective(str(objective_name), namespace=self.onto,
    ...
    # - value: (True, False ) Meaning whether or not the component is working OK
